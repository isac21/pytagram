...
from pytagram.views import LoginRequiredMixin
...
class PhotoChangeLV(LoginRequiredMixin, ListView):
    model = Photo
    template_name= 'photos/photo_change_list.html'
...
# Add, Chagne, Update, Delete for Album
# Change, Delete for Album
class AlbumChangeLV(LoginRequiredMixin, ListView):
    template_name = 'photos/album_change_list.html'
